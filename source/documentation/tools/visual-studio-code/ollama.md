...
1. Make sure you have already requested GPU [computing resources for your VS Code environment](../index.html#computing-resources). You will not be able to use Ollama without a GPU-enabled environment.
...
1. Now you can interact with the model in the terminal in a chat-like fashion as demonstrated below:
