...
2. Open the control panel, navigate to Analytical tools, click [resetting your home directory](https://controlpanel.services.analytical-platform.service.justice.gov.uk/reset-user-home/).
