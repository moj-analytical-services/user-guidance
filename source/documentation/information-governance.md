...
If you are an admin for a data source or app, you can control which users have access from the Analytical Platform control panel.

Some app access permissions can also be specified in the `deploy.json` file.
