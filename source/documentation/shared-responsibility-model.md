...
Some responsibilities are shared between users and the Analytical Platform team or another team; check the **Notes column** for details, including how to get support with a particular task.

## Documentation

| Responsibility                                                                              | Analytical Platform | User  | Other MoJ Team | Notes                                                                                                                                                                                                                                                                         |
| :------------------------------------------------------------------------------------------- | :-------------------: | :-----: | :--------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Owning the Analytical Platform User Guidance                                                | ✅                |  |           | The Analytical Platform team are responsible.                                                                                                                                                                                                                         |
| Reviewing Analytical Platform User Guidance content                                         | ✅                |  |           | The Analytical Platform team are responsible.                                                                                                                                                                                                                         |
| Updating Analytical Platform User Guidance content                                          | ✅                | ✅  |           | Anyone can make updates but they must contact the Analytical Platform team, who will review and approve any changes before merging.                                                                                                                                   |
| Migrating content from another source to the Analytical Platform User Guidance              | ✅                |  |           | Anyone with prospective content should contact the Analytical Platform team.                                                                                                                                                                                          |
| Providing support for the Analytical Platform User Guidance documentation tooling           | ✅                |  |           | The Analytical Platform team are responsible.                                                                                                                                                                                                                         |
| Updating this Shared Responsibility Model                                                   | ✅                |  |           | It is up to teams to define their respective responsibilities and relay them to the Analytical Platform team, who should then update this model accordingly.                                                                                                          |
...
| Updating GitHub READMEs                                                                     | ✅                |  |           | Teams should follow [The GDS Way's guidance on writing READMEs](https://gds-way.cloudapps.digital/manuals/readme-guidance.html) and contact the Analytical Platform team to review README content.                                                                    |
...
| Creating Analytical Platform accounts       | ✅                | ✅ |           | Users login to the Analytical Platform with their GitHub accounts, but require access to the MoJ Analytical Services GitHub organisation.<br><br>Users should email analytical-platform@justice.gov.uk their role, team and reasons for requiring access to the AP; successful requests will receive an invitation to join the organisation in response.<br><br>If users do not receive a response within 24 hours, they can follow up in the **#ask-analytical-platform** Slack channel on the **Justice Digital workspace**. |
...
### User applications (including R Shiny apps)
